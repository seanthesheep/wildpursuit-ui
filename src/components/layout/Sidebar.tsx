...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="bg-gray-900 text-white h-full flex flex-col w-16 lg:w-64 transition-all duration-300 ease-in-out">
          ...
          <ul className="space-y-1">
            <li>
              ...
              >
                ...
                <span className="hidden lg:block ml-3">Map</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="hidden lg:block ml-3">Weather</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="hidden lg:block ml-3">Trail Cameras</span>
              </NavLink>
            </li>
            {/* <li>
              <NavLink
              ...
              >
                ...
                <span className="hidden lg:block ml-3">Harvest Log</span>
              </NavLink>
            </li> */}
                    ...
                    return (
                      <li key={clubId}>
                        ...
                        >
                          ...
                          <span className="hidden lg:block ml-3 truncate" title={club.name}>
                            {club.name}
                          </span>
                        </NavLink>
                      </li>
